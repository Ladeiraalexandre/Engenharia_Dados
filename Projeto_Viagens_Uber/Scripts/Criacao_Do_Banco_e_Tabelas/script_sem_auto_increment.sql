...
-- Schema viagemdb
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `viagemdb` DEFAULT CHARACTER SET UTF8MB4 ;
USE `viagemdb` ;
...
CREATE TABLE IF NOT EXISTS `viagemdb`.`ft_viagem` (
  ...
  `num_score_motorista` INT NOT NULL,
  `num_score_cliente` INT NOT NULL,
